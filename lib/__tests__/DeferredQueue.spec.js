...
describe.only('DeferredQueue', function() {
    ...
    before(async function() {
        await cmd.run_('./node_modules/.bin/genx-eml build -c ./test/DeferredQueue/conf/app.default.json');
        await cmd.run_('./node_modules/.bin/genx-eml migrate -c ./test/DeferredQueue/conf/app.default.json -r');
...
//# sourceMappingURL=DeferredQueue.spec.js.map