...
describe('DeferredQueue', function () {
    ...
    before(async function () {
        await runCmd_('./node_modules/.bin/genx-eml build -c ./test/DeferredQueue/conf/app.default.json');
        await runCmd_('./node_modules/.bin/genx-eml migrate -c ./test/DeferredQueue/conf/app.default.json -r');
